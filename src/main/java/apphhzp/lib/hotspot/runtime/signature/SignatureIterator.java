...
public class SignatureIterator {
    ...
    /** Returns the set fingerprint, or {@code zero_fingerprint()} if none has been set already.*/
     ...
     * By convention, this object is in the subclass itself, so the call is {@code do_parameters_on(this)}.
