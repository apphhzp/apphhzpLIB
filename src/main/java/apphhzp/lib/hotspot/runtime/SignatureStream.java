...
public class SignatureStream {
    ...
    public boolean at_return_type()                    { return _state == (int)_s_method_return; }
    public boolean is_done()                           { return _state < 0; }
    public boolean is_reference(){ return is_reference_type(_type); }
    public boolean is_array(){ return _type == BasicType.T_ARRAY; }
    public boolean is_primitive(){ return is_java_primitive(_type); }
    public @RawCType("BasicType")int type()    { return _type; }

    public @RawCType("u1*") long raw_bytes(){ return _signature.bytes() + _begin; }
    public int       raw_length(){ return _end - _begin; }
    public int raw_symbol_begin(){ return _begin + (has_envelope() ? 1 : 0); }
    public int raw_symbol_end(){ return _end  -  (has_envelope() ? 1 : 0); }
