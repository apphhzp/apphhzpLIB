...
public class X86XMMRegister extends AbstractRegister {
    public X86XMMRegister(int value) {
        super(value);
    }
    ...
    public VMReg as_VMReg() {
        return VMRegImpl.as_VMReg((encoding() << 4) + X86ConcreteRegisterImpl.max_fpr);
    }

    public X86XMMRegister successor() {
        return new X86XMMRegister(encoding() + 1);
    }
    ...
    public boolean is_valid() {
        return 0 <=  this.value &&this.value < X86XMMRegisterImpl.number_of_registers;
    }

    private static final String[] names = PlatformInfo.isX86_64() ? new String[]{
            "xmm0", "xmm1", "xmm2", "xmm3", "xmm4", "xmm5", "xmm6", "xmm7"
            , "xmm8", "xmm9", "xmm10", "xmm11", "xmm12", "xmm13", "xmm14", "xmm15"
            , "xmm16", "xmm17", "xmm18", "xmm19", "xmm20", "xmm21", "xmm22", "xmm23"
            , "xmm24", "xmm25", "xmm26", "xmm27", "xmm28", "xmm29", "xmm30", "xmm31"} :
            new String[]{"xmm0", "xmm1", "xmm2", "xmm3", "xmm4", "xmm5", "xmm6", "xmm7"};
    public String name(){
        return is_valid() ? names[encoding()] : "xnoreg";
    }
    private static final String[] sub_names = PlatformInfo.isX86_64()?new String[]{
    ...
    public String sub_word_name(int i) {
        if (!(i >= 0 && i < 8)){
            throw new IllegalArgumentException("offset too large");
        }
        return is_valid() ? sub_names[encoding() * 8 + i] : "xnoreg";
    }
}
