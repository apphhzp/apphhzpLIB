...
//                if (ClassHelperSpecial.findLoadedClass(ApphhzpLibService.class.getClassLoader(), name) == null) {
//                    ClassHelperSpecial.defineClass(name, b, ApphhzpLibService.class.getClassLoader());
//                }
//            }
//        } catch (Throwable t) {
...
//        }
        ...
        ClassHelperSpecial.defineClassesFromJar(ApphhzpLibService.class, s-> isHotspotJVM||!s.startsWith("apphhzp.lib.hotspot"));
